            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="menu-wrap">
                        <nav class="menu-nav">
                            <div class="logo">
                                <a href="/home1"><img src="assets/img/logo/logo.svg" alt=""></a>
                            </div>
                            <div class="navbar-wrap main-menu d-none d-lg-flex">
                                <ul class="navigation">
                                    <li class="active menu-item-has-children"><a href="#header" class="section-link">Home</a>
                                        <ul class="sub-menu">
                                            <li><a href="/home1">Home One</a></li>
                                            <li class="active"><a href="/home2">Home Two</a></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="mobile-menu">
                        <nav class="menu-box">
                            ...
                            <div class="nav-logo"><a href="/home1"><img src="assets/img/logo/logo.svg" alt="" title=""></a>
                            </div>
